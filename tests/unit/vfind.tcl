start_server {tags {"vfind"}} {
  ...
  proc basics {encoding} {
    ...
    test "vfind parameter number - $encoding" {
      ...
      assert_error $err {r vfind list 0 10 1000 desc noblocked details}
      assert_error $err {r vfind list 0 10 1000 desc noblocked details 0}
      assert_error $err {r vfind list 0 10 1000 desc noblocked details 0 0}
      assert_error $err {r vfind list 0 10 1000 desc noblocked details 1 0}
      assert_error $err {r vfind list 0 10 1000 desc noblocked details 0 1}
      assert_error $err {r vfind list 0 10 1000 desc noblocked details 0 0 0}
      assert_error $err {r vfind list 0 10 1000 desc noblocked details 0 0 0}
    }
    ...
    test "vfind invalid offset count of up_to - $encoding" {
      ...
      assert_error $err {r vfind zset a 10 1000 desc noblocked details co:us co:* 0 0 0}
      assert_error $err {r vfind zset 0 b 1000 desc noblocked details co:us co:* 0 0 0}
      assert_error $err {r vfind zset 0 10 c desc noblocked details co:us co:* 0 0 0}
    }
    ...
    test "vfind invalid list type - $encoding" {
      ...
      assert_error $err {r vfind myset 0 10 1000 desc noblocked details co:us co:* 0 0 0}
    }

    test "vfind returns empty for a missing list - $encoding" {
      assert_equal {0} [r vfind x 0 10 1000 desc noblocked details co:us co:* 0 0 0]
    }
    ...
    test "vfind filter and holdback descending - $encoding" {
      ...
      assert_equal $expected [r vfind zset 0 10 11 desc noblocked details co:us co:* 0 1 cap 1 filter1]
    }
    ...
    test "vfind filter holdback ascending $encoding" {
      ...
      assert_equal $expected [r vfind zset 0 10 11 asc noblocked details co:us co:* 0 1 cap 1 filter1]
    }

    test "vfind filter all with a non existing filter - $encoding" {
      setup_data
      r sadd cap a
      assert_equal {0} [r vfind zset 0 10 11 asc noblocked details co:us co:* 0 1 cap 1 filter2]
    }
    ...
    test "vfind no holdbacks - $encoding" {
      ...
      assert_equal $expected [r vfind zset 0 10 11 desc noblocked details co:us co:* 0 0 1 filter1]
    }

    test "vfind holdback all - $encoding" {
      setup_data
      r sadd cap d v g f c mnm
      assert_equal {0} [r vfind zset 0 10 11 desc noblocked details co:us co:* 0 1 cap 1 filter1]
    }
    ...
    test "vfind mulitple filters - $encoding" {
      ...
      r sadd cap d v
      assert_equal {{{"s_g":1,"blocked":false}} 1} [r vfind zset 0 10 11 desc noblocked details co:us co:* 0 1 cap 2 filter1 filter2]
    }
    ...
    test "vfind mulitple filters 2 - $encoding" {
      ...
      r sadd cap u a j
      assert_equal {{{"s_d":1,"blocked":false}} {{"s_g":1,"blocked":false}} 2} [r vfind zset 0 10 11 desc noblocked details co:us co:* 0 1 cap 2 filter1 filter2]
    }
    ...
    test "vfind mulitple filters 3 - $encoding" {
      ...
      r sadd cap d
      assert_equal {{{"s_g":1,"blocked":false}} {{"s_v":1,"blocked":false}} 2} [r vfind zset 0 10 11 asc noblocked details co:us co:* 0 1 cap 2 filter1 filter2]
    }
    ...
    test "vfind mulitple filters 4 - $encoding" {
      ...
      r sadd filter2 d v g
      r sadd cap d
      assert_equal {{{"s_v":1,"blocked":false}} {{"s_g":1,"blocked":false}} 2} [r vfind zset 0 10 11 desc noblocked details co:us co:* 0 1 cap 2 filter1 filter2]
    }

    test "vfind paging offset - $encoding" {
      setup_data
      r sadd cap v x
      assert_equal {{{"s_f":1,"blocked":false}} {{"s_c":1,"blocked":false}} 5} [r vfind zset 2 2 10 desc noblocked details co:us co:* 0 1 cap 1 filter1]
    }

    test "vfind paging offset 2 - $encoding" {
      setup_data
      r sadd cap v x
      assert_equal {{{"s_g":1,"blocked":false}} {{"s_f":1,"blocked":false}} 5} [r vfind zset 1 2 10 desc noblocked details co:us co:* 0 1 cap 1 filter1]
    }

    test "vfind paging offset ascending - $encoding" {
      setup_data
      r sadd cap v x
      assert_equal {{{"s_a":1,"blocked":false}} {{"s_c":1,"blocked":false}} 7} [r vfind zset 1 2 10 asc noblocked details co:us co:* 0 1 cap 0]
    }
    ...
    test "vfind anti cap - $encoding" {
      ...
      assert_equal $expected [r vfind zset 0 10 10 asc noblocked details co:us co:* 1 anti 1 cap 1 filter1]
    }

    test "vfind upto limit - $encoding" {
      setup_data
      r sadd cap v x
      assert_equal {{{"s_f":1,"blocked":false}} {{"s_e":1,"blocked":false}} 4} [r vfind zset 2 2 3 desc noblocked details co:us co:* 0 1 cap 0]
    }
    ...
    test "bricks 1 - $encoding" {
      ...
      assert_equal $expected [r vfind a_zset 0 10 10 desc noblocked details co:us co:* 0 1 cap 0]
    }
    ...
    test "vfind get specific field - $encoding" {
      ...
      assert_equal $expected [r vfind zset 0 10 10 desc noblocked en co:us co:* 0 0 1 filter1]
    }
    ...
    test "vfind applies inclusion list - $encoding" {
      ...
      assert_equal $expected [r vfind zset 0 10 11 excl noblocked details co:us co:* 1 incl 1 cap 1 filter1]
    }
    ...
    test "vfind applies exclusion list - $encoding" {
      ...
      r sadd cap a c f z y mnm
      r sadd excl v d
      assert_equal {{{"s_g":1,"blocked":false}} 1} [r vfind zset 0 10 11 desc noblocked details co:us co:* 0 2 cap excl 1 filter1]
    }
    ...
    test "vfind applies include blocked list using vfindZWithFilters - $encoding" {
      ...
      assert_equal $expected [r vfind zset 1 2 10 desc withblocked details co:us co:* 0 1 cap 1 filter1]
    }
    ...
    test "ignores missing allows set - $encoding" {
      ...
      assert_equal $expected [r vfind zset 0 10 11 asc withblocked details co:us co:* 1 anti 0 2 filter1 filter2]
    }
    ...
    test "includes the global owner - $encoding" {
      ...
      r hset r:a co:* 123co
      r sadd cap v x
      assert_equal {{{"s_a":1,"owner":"123co","blocked":false}} {{"s_c":1,"blocked":false}} 7} [r vfind zset 1 2 10 asc noblocked details co:us co:* 0 1 cap 0]
    }

    test "includes the country owner owner - $encoding" {
      setup_data
      r hset r:a co:* 123co
      r hset r:a co:kr 111co
      r sadd cap v x
      assert_equal {{{"s_a":1,"owner":"111co","blocked":false}} {{"s_c":1,"blocked":false}} 7} [r vfind zset 1 2 10 asc noblocked details co:kr co:* 0 1 cap 0]
    }
  }
  basics ziplist
  basics skiplist
