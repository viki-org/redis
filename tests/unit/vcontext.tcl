start_server {tags {"vcontext"}} {
  proc setup_data {} {
    r del x:g1 x:g2 x:us x:ca x:mx cap
  ...
  test "syntax error for wrong number of filters and indexes" {
    ...
    assert_error $err {r vcontext 1 abc 1}
    assert_error $err {r vcontext 0 1 abc}
    assert_error $err {r vcontext 1 abc 1 abc}
  }

  test "nothing for an invalid set" {
    setup_data
    assert_equal {} [r vcontext 1 abc 1 x:us cap]
  }

  test "nothing for an invalid index" {
    setup_data
    assert_equal {} [r vcontext 1 x:g1 1 x9001 cap]
  }
